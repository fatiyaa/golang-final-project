...
import (
	...
	"github.com/fatiyaa/golang-final-project/constants"
...
func (s *userService) Register(ctx context.Context, req dto.UserCreateRequest) (dto.UserResponse, error) {
	...
	return dto.UserResponse{
		ID:         strconv.FormatInt(userReg.ID, 10),
		Name:       userReg.Name,
...
func (s *userService) GetUserByEmail(ctx context.Context, email string) (dto.UserResponse, error) {
	...
	return dto.UserResponse{
		ID:         strconv.FormatInt(emails.ID, 10),
		Name:       emails.Name,
...
func (s *userService) Delete(ctx context.Context, userId string) error {
	...
	err = s.userRepo.DeleteUser(ctx, nil, strconv.FormatInt(user.ID, 10))
	if err != nil {
...
func (s *userService) Verify(ctx context.Context, req dto.UserLoginRequest) (dto.UserLoginResponse, error) {
	...
	token := s.jwtService.GenerateToken(strconv.FormatInt(check.ID, 10), check.Role)
